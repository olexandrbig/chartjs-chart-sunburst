...
var SunburstController = (function (Chart$$1) {
  Chart$$1.controllers.sunburst = Chart$$1.DatasetController.extend({
    ...
    updateElement: function updateElement(arc, index, reset) {
      ...
      var itemData = dataset.data && dataset.data.find(function (item){
        return item.id === model.id
      }) || {}
      model.backgroundColor = itemData.backgroundColor ? itemData.backgroundColor :
        valueOrDefault(custom.backgroundColor, index, elementOpts.backgroundColor)
      model.borderColor = itemData.borderColor ? itemData.borderColor :
